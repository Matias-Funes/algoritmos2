...
def main():
    ...
    def run_game_logic_tick():
        ...
        # 6. GRABAR FOTOGRAMA PARA REPLAY (liviano, en cada tick)
        try:
            replay_buffer.append(get_lightweight_state())
        except Exception as e:
            print(f"Error al grabar frame liviano del replay: {e}")

        
        # Guardar el estado completo en el historial (para retroceder en el juego normal)
        try:
